...
export default function App() {
  ...
  const matchedSkills = jobProfile.requiredSkills.filter((skill) =>
    userSkills.includes(skill)
  );
  const missingSkills = jobProfile.requiredSkills.filter(
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      ...
      <p className="mb-2">
        Target Role: <strong>{jobProfile.title}</strong>
      </p>
